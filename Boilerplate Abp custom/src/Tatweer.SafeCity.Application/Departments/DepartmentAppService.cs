...
{
    public class DepartmentAppService :SafeCityAppServiceBase, IDepartmentAppService
    {
        ...
        {
            return this.CreateUpdateDepartment(departmentDto);
        }
        ...
        public bool DeleteDepartment(int id)
        {
            ...
            if (department != null)
            {
                ...
                this._departmentRepository.InsertOrUpdate(department);
                response = true;
            }
            return response;
        }
        ...
        private bool CreateUpdateDepartment(DepartmentDto departmentDto)
        {
            try
            {
                ...
                if (departmentDto != null)
                {
                   ...
                   // _auditLogBusiness.InsertAuditLog(entityType, Convert.ToInt32(_abpSession.UserId), res, "Department");
                    response = true;
                }
                return response;
            }
