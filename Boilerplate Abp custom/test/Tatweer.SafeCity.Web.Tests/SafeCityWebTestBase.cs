...
using Tatweer.SafeCity.Models.TokenAuth;
...
{
    public abstract class SafeCityWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SafeCityWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SafeCityWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SafeCityDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SafeCityDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SafeCityDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SafeCityDbContext, Task<T>> func)
        {
            T result;
