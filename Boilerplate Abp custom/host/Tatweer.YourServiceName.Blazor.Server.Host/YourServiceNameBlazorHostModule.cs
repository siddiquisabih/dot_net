...
using Tatweer.YourServiceName.Blazor.Server.Host.Components;
using Tatweer.YourServiceName.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(YourServiceNameBlazorServerModule)
)]
public class YourServiceNameBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(YourServiceNameResource),
                typeof(YourServiceNameDomainModule).Assembly,
                typeof(YourServiceNameDomainSharedModule).Assembly,
                typeof(YourServiceNameApplicationModule).Assembly,
                typeof(YourServiceNameApplicationContractsModule).Assembly,
                typeof(YourServiceNameBlazorHostModule).Assembly
            );
        });
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("YourServiceName");
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles(new BundleFile("/Tatweer.YourServiceName.Blazor.Server.Host.styles.css", true));
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<YourServiceNameBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.MenuContributors.Add(new YourServiceNameMenuContributor());
        });

        Configure<AbpRouterOptions>(options =>
        {
            options.AppAssembly = typeof(YourServiceNameBlazorHostModule).Assembly;
        });
    ...
    public override async Task OnApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "YourServiceName API");
        });
