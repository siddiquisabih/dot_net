...
namespace Tatweer.SafeCity.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AuditTypeCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConnectionStartTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSignalrConnections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserSignalrConnections_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditLogs_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "UserDepartmentSupervisors",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDepartmentSupervisors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserDepartmentSupervisors_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserNotificationGroup", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserNotificationGroup_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserNotificationGroup_NotificationGroups_NotificationGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDepartmentSupervisors_DepartmentId",
                table: "UserDepartmentSupervisors",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_UserNotificationGroup_NotificationGroupId",
                table: "UserNotificationGroup",
                column: "NotificationGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_UserNotificationGroup_UserId",
                table: "UserNotificationGroup",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSignalrConnections_UserId",
                table: "UserSignalrConnections",
                column: "UserId");
        }
