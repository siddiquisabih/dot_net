...
namespace Tatweer.RadarManagment.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = RadarManagmentConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(RadarManagmentDbContext context)
        {
            _context = context;
        }
